...
sub clean_html_text {
    ...
    s/\&\#8220;/\"/g;   s/\&ldquo;/\"/g; s/(\342\200\234|\x{201c})/\"/g;   # ISOnum left double-quote (U+201C, &#8220;)
    s/\&\#8221;/\"/g;   s/\&rdquo;/\"/g; s/(\342\200\235|\x{201d})/\"/g;   # ISOnum right double-quote (U+201D, &#8221;)
...
SystemC::Vregs::Input::TableExtract - Superclass of HTML::TableExtract for vregs usage
...
SystemC::Vregs::Input::TableExtract is a superclass of HTML::TableExtract which
